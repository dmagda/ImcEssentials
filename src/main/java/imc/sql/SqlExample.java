...
/**
 * Example to showcase DDL capabilities of Ignite's SQL engine. <p> Remote nodes could be started from command line as
 * follows: {@code 'ignite.{sh|bat} config/ignite-configuration.xml'}. <p> Alternatively you can run {@link NodeStartup}
 * in either same or another JVM.
 */
