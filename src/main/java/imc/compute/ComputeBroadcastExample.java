 ...
 * enables P2P class loading: {@code 'ignite.{sh|bat} config/ignite-configuration.xmll'}.
 * <p>
 * Alternatively you can run {@link NodeStartup} in another JVM which will start node
 * with {@code config/ignite-configuration.xml} configuration.
 */
